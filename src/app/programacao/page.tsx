...
export default function Programacao() {
    ...
    return(
        <div className="bg-[var(--vdi-bg)] overflow-hidden pb-10">
            ...
            <div className="max-w-[var(--largura)] mx-auto px-5 programacao">

                <div className="py-5">
                    <Link href="/" className="text-white flex items-center gap-2 border-2 border-[var(--azul-neon)] px-5 py-2 w-fit rounded-full mb-5"><ArrowLeft className="text-[var(--azul-neon)]" />Voltar</Link>
                </div>
                ...
                <div className="bg-[#2767702B] mt-3 md:mt-5 px-5 py-10 rounded-lg text-center">
                    ...
                    <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">12h00 – 14h00</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">14h00 – 14h50</span>
                        <p className="text-white font-bold text-sm">5. Princípios básicos de IA para negócios</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">14h50 – 15h40</span>
                        <p className="text-white font-bold text-sm mb-2">6. Treinamento de time e CRM automatizado com IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Yago Martins</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">15h40 – 16h00</span>
                        <p className="text-white font-bold text-sm mb-2">Q&A com fundadores</p>
                        <div className="block">
                            <p className="font-bold text-[var(--azul-neon)] uppercase">Yago Martins</p>
                            <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    ...
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">16h00 – 16h30</span>
                        <p className="text-white font-bold text-sm">Break</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">16h30 – 16h55</span>
                        <p className="text-white font-bold text-sm mb-2">7. Prospecção ativa com IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">16h55 – 17h20</span>
                        <p className="text-white font-bold text-sm mb-2">Prompts para desenvolver a IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">17h20 – 18h10</span>
                        <p className="text-white font-bold text-sm mb-2">9. Construção de SaaS com IA – Plataforma Viver de IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">18h00 – 18h30</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
                    ...
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">09h00 – 09h52</span>
                        <p className="text-white font-bold text-sm mb-2">10. Análise de dados com IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">09h52 – 10h22</span>
                        <p className="text-white font-bold text-sm">11. IA e inovação em modelos de negócios</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">10h22 – 11h14</span>
                        <p className="text-white font-bold text-sm">12. Gestão financeira inteligente com IA</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">11h14 – 11h44</span>
                        <p className="text-white font-bold text-sm mb-2">Q&A com fundadores</p>
                        <div className="block">
                            <p className="font-bold text-[var(--azul-neon)] uppercase">Yago Martins</p>
                            <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    ...
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">11h30 – 12h00</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">14h00 – 14h52</span>
                        <p className="text-white font-bold text-sm mb-2">13. Recrutamento e seleção com IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">14h52 – 15h44</span>
                    ...
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">16h30 – 17h22</span>
                        <p className="text-white font-bold text-sm mb-2">15. Estrutura de time com IA</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Yago Martins</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">17h22 – 17h42</span>
                        <p className="text-white font-bold text-sm mb-2">16. Visão de futuro</p>
                        <p className="font-bold text-[var(--azul-neon)] uppercase">Rafael Milagre</p>
                    </div>
                    <div className="bg-[#2767702B] px-5 py-10 rounded-lg">
                        <Image src={"/asteristico-azul.svg"} width={30} height={30} alt="Viver de IA"/>
                        <span className="bg-[var(--azul-neon)] rounded-full text-sm px-3 py-1 mt-5 mb-4 inline-block">17h42 – 18h00</span>
